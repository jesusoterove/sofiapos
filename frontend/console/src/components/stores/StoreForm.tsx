      ...
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              type="text"
              value={isEditing ? (store?.code || '') : (formData.name ? `${formData.name[0]?.toUpperCase() || 'S'}XX` : '')}
              className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:outline-none disabled:bg-gray-100 disabled:text-gray-500"
